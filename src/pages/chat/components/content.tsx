...
const Content: React.FC<ContentProps> = ({ toggleSidebar, showSidebar }) => {
  return (
    <>
      <div className={`${showSidebar ? "hidden" : "block"} sm:block`}>
        <div className="flex flex-col bg-white sm:rounded-lg">
          <div className="flex flex-row justify-between p-[10px] border-b border-gray-200">
            <div className="flex flex-row">
              <span
                className="items-center mr-[5px] flex sm:hidden cursor-pointer"
          ...
          <div className="flex flex-col h-screen pb-[98px] sm:pb-[118px] gap-[10px]">
            <div className="flex-1 flex overflow-y-auto pt-[18px] pb-[8px] flex-col-reverse px-[18px] gap-[10px] style-scrool-chat">
              {/* My comment */}
              <div className="block">
                  ...
                  <div className="flex flex-col gap-[4px]">
                    <div className="flex flex-row justify-start gap-[10px] group/mesage-chat">
                      <div className="p-[15px] pb-[40px] bg-sky-200 text-gray-400 rounded-xl max-w-[70%] flex flex-col gap-[10px]">
                        <p>
                          Tailwind lets you conditionally apply utility classes
                          in different states using variant modifiers. For
                          example, use hover:opacity-100 to only apply the
            ...
            <div className="flex flex-row gap-[15px] items-end pl-[18px] pr-[15px]">
              ...
              <div className="relative flex flex-1">
                <textarea
                  rows={1}
                  className="block resize-none w-full p-[10px] pr-[40px] text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 outline-0"
                ></textarea>
