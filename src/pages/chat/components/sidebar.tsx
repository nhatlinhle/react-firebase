...
const Sidebar: React.FC<ContentProps> = ({showSidebar, toggleSidebar}) => {
  const times = Array.from({ length: 30 });

  return (
    <>
      <div className={`${!showSidebar ? 'hidden' : ''} sm:block w-full sm:min-w-[350px] sm:w-[350px]`}>
          ...
          <div className="h-screen pb-[100px]">
            <div className="style-scrool-chat overflow-y-auto flex flex-col h-full pr-[10px] py-[18px] pl-[18px]">
              <div
                ...
                className="py-[15px] pl-[15px] pr-[25px] flex flex-row gap-[15px] rounded-lg bg-sky-600 text-white cursor-pointer"
              >
